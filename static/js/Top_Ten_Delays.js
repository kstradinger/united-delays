function buildCharts2(){
  ...
  trace1 = {
    ...
    name: '', 
    type: 'bar', 
    xsrc: 'ellowe:6:50c7b2', 
    x: ['Chicago, IL(ORD)', 'Dallas/Fort Worth, TX(DFW)', 'Atlanta, GA(ATL)', 'Newark, NJ(EWR)', 'San Francisco, CA(SFO)', 'Houston, TX(IAH)', 'Los Angeles, CA(LAX)', 'Denver, CO(DEN)', 'Charlotte, NC(CLT)', 'Orlando, FL(MCO)'], 
    ysrc: 'ellowe:6:8365e9', 
    y: [311398, 256238, 251102, 196394, 188718, 188429, 183501, 173122, 171791, 162086], 
    xaxis: 'x', 
    yaxis: 'y', 
    marker: {color: '#636efa'}, 
    ...
    orientation: 'v', 
    textposition: 'auto', 
    hovertemplate: 'Airport=%{x}<br>Total Delayed(Minutes)=%{y}', 
    alignmentgroup: 'True'
  };
  data = [trace1];
  layout = {
    ...
    yaxis: {
      type: 'linear', 
      range: [0, 327787.36842105264], 
      title: {text: 'Total Delayed(Minutes)'}, 
      anchor: 'x', 
      domain: [0, 1], 
      autorange: true
    }, 
