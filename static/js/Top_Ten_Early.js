function buildCharts3() {
  trace1 = {
    ...
    name: '', 
    type: 'bar', 
    xsrc: 'hjwaichulis:0:af9fe5', 
    x: ['Kona, HI(KOA)', 'Lihue, HI(LIH)', 'Hilo, HI(ITO)', 'Yakutat, AK(YAK)', 'Cordova, AK(CDV)', 'Scottsbluff, NE(BFF)', 'Nome, AK(OME)', 'Kahului, HI(OGG)', 'Duluth, MN(DLH)', 'North Platte, NE(LBF)'], 
    ysrc: 'hjwaichulis:0:0afd4d', 
    y: [-3308, -901, -597, -558, -454, -335, -242, -206, -202, -196], 
    xaxis: 'x', 
    yaxis: 'y', 
    marker: {color: '#636efa'}, 
    ...
    orientation: 'v', 
    textposition: 'auto', 
    hovertemplate: 'Airport=%{x}<br>Total Early(Minutes)=%{y}', 
    alignmentgroup: 'True'
  };
  data = [trace1];
  layout = {
    ...
    yaxis: {
      type: 'linear', 
      range: [-3482.1052631578946, 0], 
      title: {text: 'Total Early(Minutes)'}, 
      anchor: 'x', 
      domain: [0, 1], 
      autorange: true
    }, 
